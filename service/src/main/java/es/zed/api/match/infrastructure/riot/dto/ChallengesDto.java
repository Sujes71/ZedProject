...
public class ChallengesDto extends Dto {

  @JsonAlias("12assistStreakCount")
  ...
  public void setAssistStreakCount(int assistStreakCount) {
  ...
  public int getSwarmDefeatAatrox() {
    return swarmDefeatAatrox;
  }

  public void setSwarmDefeatAatrox(int swarmDefeatAatrox) {
    this.swarmDefeatAatrox = swarmDefeatAatrox;
  }

  public int getSwarmDefeatBriar() {
    return swarmDefeatBriar;
  }

  public void setSwarmDefeatBriar(int swarmDefeatBriar) {
    this.swarmDefeatBriar = swarmDefeatBriar;
  }

  public int getSwarmDefeatMiniBosses() {
    return swarmDefeatMiniBosses;
  }

  public void setSwarmDefeatMiniBosses(int swarmDefeatMiniBosses) {
    this.swarmDefeatMiniBosses = swarmDefeatMiniBosses;
  }

  public int getSwarmEvolveWeapon() {
    return swarmEvolveWeapon;
  }

  public void setSwarmEvolveWeapon(int swarmEvolveWeapon) {
    this.swarmEvolveWeapon = swarmEvolveWeapon;
  }

  public int getSwarmHave3Passives() {
    return swarmHave3Passives;
  }

  public void setSwarmHave3Passives(int swarmHave3Passives) {
    this.swarmHave3Passives = swarmHave3Passives;
  }

  public int getSwarmKillEnemy() {
    return swarmKillEnemy;
  }

  public void setSwarmKillEnemy(int swarmKillEnemy) {
    this.swarmKillEnemy = swarmKillEnemy;
  }

  public float getSwarmPickupGold() {
    return swarmPickupGold;
  }
  ...
  public int getSwarmReachLevel50() {
    return swarmReachLevel50;
  }

  public void setSwarmReachLevel50(int swarmReachLevel50) {
    this.swarmReachLevel50 = swarmReachLevel50;
  }

  public int getSwarmSurvive15Min() {
    return swarmSurvive15Min;
  }

  public void setSwarmSurvive15Min(int swarmSurvive15Min) {
    this.swarmSurvive15Min = swarmSurvive15Min;
  }

  public int getSwarmWinWith5EvolvedWeapons() {
    return swarmWinWith5EvolvedWeapons;
  }

  public void setSwarmWinWith5EvolvedWeapons(int swarmWinWith5EvolvedWeapons) {
